...
public class BillController {
    ...
    @RequiresRole({RolEnum.ADMIN, RolEnum.MECANICO})
    public ResponseEntity<Bill> assign(@PathVariable Long id, @RequestParam Integer identfication, @RequestParam String plate) {
        try {
    ...
    public ResponseEntity<List<Bill>> history(@RequestParam Integer identification,@RequestParam(required = false) String plate) {
        try {
    ...
    @GetMapping("/reporte")
    @RequiresRole({RolEnum.ADMIN})
    public ResponseEntity<List<Bill>> report(@RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate start,
    ...
    @GetMapping("/caja")
    @RequiresRole({RolEnum.ADMIN})
    public ResponseEntity<CashierResponseDTO> cashier(@RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate start,
            @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate end) {
        try {
